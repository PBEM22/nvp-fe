...
export type EmailCheckResponseWrapper = ApiResponse<EmailCheckResponse>;

/**
 * 회원 API 응답 타입
 */
export type MemberDetailResponseWrapper = ApiResponse<MemberDetailResponse>;
export type MemberUpdateResponse = ApiResponseUnit;
export type MemberWithdrawResponse = ApiResponseUnit;
export type MemberListResponse = ApiResponse<PageResponse<MemberSummaryResponse>>;
export type PageMemberSummaryResponse = PageResponse<MemberSummaryResponse>;
export type PageMemberInfoResponse = PageResponse<MemberInfoResponse>;
export type MemberInfoListResponse = ApiResponse<PageMemberInfoResponse>;
export type AdminMemberListResponse = ApiResponse<PageMemberSummaryResponse>;
export type AdminMemberListResponseWrapper = ApiResponse<PageMemberSummaryResponse>;
...
export type TodayAttendanceResponseWrapper = ApiResponse<TodayAttendanceResponse>;
...
export type PeriodResponseWrapper = ApiResponse<PeriodResponse>;
...
export type UpdateUserAccountStatusResponse = ApiResponseUnit;
export type AdminMemberWithdrawResponse = ApiResponseUnit;
 ...
 * 기수별 회원 출석 요약 정보
 */
export interface PeriodMemberAttendanceSummaryResponse {
  /** 회원 ID */
  memberId: number;
  /** 회원 이름 */
  memberName: string;
 ...
 * 기수별 출석 요약 목록 응답
 */
export type PeriodMemberAttendanceSummaryListResponse = ApiResponse<PeriodMemberAttendanceSummaryResponse[]>;
